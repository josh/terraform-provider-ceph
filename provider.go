...
func (p *CephProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		newCephFSSnapshotResource,
		newCephFSSubvolumeResource,
		newCephFSSubvolumeGroupResource,
		newCephFSSubvolumeSnapshotResource,
		newConfigResource,
		newCrushRuleResource,
		newDashboardRoleResource,
		newDashboardSettingResource,
		newDashboardUserResource,
		newErasureCodeProfileResource,
		newMgrModuleConfigResource,
		newPoolResource,
		newRBDImageResource,
		newRBDMirroringPoolModeResource,
		newRBDMirroringPoolPeerResource,
		newRBDNamespaceResource,
		newRBDSnapshotResource,
...
func (p *CephProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		newCephFSSnapshotDataSource,
		newCephFSSubvolumeDataSource,
		newCephFSSubvolumeGroupDataSource,
		newCephFSSubvolumeSnapshotDataSource,
		newConfigDataSource,
		newConfigValueDataSource,
		newCrushRuleDataSource,
		newDashboardRoleDataSource,
		newDashboardSettingDataSource,
		newDashboardUserDataSource,
		newErasureCodeProfileDataSource,
		newMgrModuleConfigDataSource,
		newPoolDataSource,
		newRBDImageDataSource,
		newRBDMirroringPoolModeDataSource,
		newRBDMirroringPoolPeerDataSource,
		newRBDNamespaceDataSource,
		newRBDSnapshotDataSource,
