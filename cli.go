...
func (c *CephCLI) RBDCreate(ctx context.Context, pool, name string, sizeMB int64) error {
...
func (c *CephCLI) RBDInfo(ctx context.Context, pool, name string) (*RBDImageInfo, error) {
...
func (c *CephCLI) RBDExists(ctx context.Context, pool, name string) (bool, error) {
	_, err := c.RBDInfo(ctx, pool, name)
	if err == nil {
		return true, nil
	}
...
func (c *CephCLI) RBDRemove(ctx context.Context, pool, name string) error {
