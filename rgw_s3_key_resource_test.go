		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ceph_rgw_s3_key.test", "key_type", "s3"),
				),
			},
		},
	})
...
func TestAccCephRGWS3KeyResource_customKeys(t *testing.T) {
	...
	customAccessKey := "CUSTOMACCESSKEY12345"
	customSecretKey := "CustomSecretKey123456789012345678901234"
