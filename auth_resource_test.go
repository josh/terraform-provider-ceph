...
func TestAccCephAuthResource(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-auth"))
...
func TestAccCephAuthResource_invalidCapType(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-invalid"))
...
func TestAccCephAuthResource_invalidCapTypeOnUpdate(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-update"))
...
func TestAccCephAuthResourceImport(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-import"))
...
func TestAccCephAuthResourceImport_nonExistent(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-nonexist"))
...
func TestAccCephAuthResource_staticKey(t *testing.T) {
	...
	testEntity := fmt.Sprintf("client.%s", acctest.RandomWithPrefix("test-static-key"))
